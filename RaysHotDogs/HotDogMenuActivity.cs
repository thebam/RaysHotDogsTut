...
namespace RaysHotDogs
{
    ...
    public class HotDogMenuActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            AddTabs("Favorites", Resource.Drawable.FavoritesIcon, new FavoriteHotDogFragment());
            AddTabs("Meat Lovers", Resource.Drawable.MeatLoversIcon, new MeatLoversFragment());
            AddTabs("Veggie Lovers", Resource.Drawable.VeggieLoversIcon, new VeggieLoversFragment());
        }

        private void AddTabs(string tabText, int iconResourceId, Fragment view) {
